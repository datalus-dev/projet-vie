...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-side">
    ...
    <ul class="menu bg-base-200 text-base-content min-h-100/100 w-42 p-8">
    ...
    <footer class="footer bg-base-200 absolute bottom-5 flex justify-center">
      <a href="https://datalus.xyz"><p class="text-center">a <em>datalus</em> endeavor.</p></a>
    </footer>
  </div>
</div>
